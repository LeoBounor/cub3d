...
/*   Updated: 2023/06/15 13:44:50 by jcollon          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	clear_textures(t_game *game)
{
	...
	{
		if (game->all_textures->east_texture && game->all_textures->east_texture->texture)
			mlx_destroy_image(game->mlx, game->all_textures->east_texture->texture);
		if (game->all_textures->west_texture && game->all_textures->west_texture->texture)
			mlx_destroy_image(game->mlx, game->all_textures->west_texture->texture);
		if (game->all_textures->north_texture && game->all_textures->north_texture->texture)
			mlx_destroy_image(game->mlx,
				game->all_textures->north_texture->texture);
		if (game->all_textures->south_texture && game->all_textures->south_texture->texture)
			mlx_destroy_image(game->mlx,
